    ...
    <>
      ...
      <div className="container max-w-full py-14">
        <div className="container max-w-full p-10 text-center animate__animated animate__fadeInRightBig">
          ...
          <p className='text-lg 2xs:px-0 xs:px-16 md:px-40 lg:px-52  xl: px-64' style={{ color: '#260B64' }}>การจัดกลุ่มหรือแยกประเภทใช้ในชีวิตประจำวัน เช่น ระบบวินิจฉัยโรคที่ช่วยแพทย์แยกชนิดของโรค การกรองอีเมลที่ช่วยแยกสแปมหรือไม่ต้องการ การแนะนำสินค้าตามประวัติการค้นหา การจัดการภาพถ่ายให้แยกตามประเภท และการรักษาความปลอดภัยด้วยการจดจำใบหน้า</p>
        </div>
      </div>
      <Footer />
    </>
